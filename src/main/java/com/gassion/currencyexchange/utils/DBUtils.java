...
public class DBUtils {
    ...
    public static final String SELECT_EXCHANGE_RATE = "Select * FROM ExchangeRates" +
            " join Currencies D on D.ID = ExchangeRates.BaseCurrencyId" +
            " join Currencies C on C.ID = ExchangeRates.TargetCurrencyId" +
